 ...
 * -------------------------------------------------------
 */
function jacks(numberOfJacks, url) {
  let jacksContainer = document.createElement("div");
  jacksContainer.className="py-10"

  for (i = 0; i < numberOfJacks; i++) {
    let img = new Image();
    img.src = url;
    img.id = "jack-one";
    img.className = "absolute rounded-lg w-32 border shadow-xl hover:w-48 transition duration-300";
  ...
  document.body.appendChild(jacksContainer)
}
...
jacks(15, "https://jayd719.github.io/assets/images/jacks/jack.png");
